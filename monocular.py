...
from Utils.utils import download_file, ensure_dir, generate_xv_folds, shift_mat_zpad
...
def monocular_data_import( datadir, exptn, num_lags=20 ):
    ...
    stim_all = shift_mat_zpad(matdata['stimulus'], time_shift, 0)
    ...
    Ui, Xi = generate_xv_folds( len(used_inds) )
